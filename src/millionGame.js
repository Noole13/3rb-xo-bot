...
const questionsBank = {
  1: [
    {
      question:
        "ما هو لون السماء الصافية في النهار؟",
      options: [
        "أحمر",
        "أزرق",
        "أخضر",
    ...
    {
      question:
        "كم عدد شهور السنة الميلادية؟",
      options: ["10", "11", "12", "13"],
      correct: 3,
    },
    {
      question:
        "ما هو الحيوان الملقب بملك الغابة؟",
      options: [
        "النمر",
        "الأسد",
        "الفيل",
    ...
    {
      question:
        "ما هي الوجبة التي تؤكل في الصباح عادة؟",
      options: [
        "الغداء",
        "العشاء",
        "الفطور",
  ...
  2: [
    ...
    {
      question:
        "ما هي عملة دولة الإمارات العربية المتحدة؟",
      options: [
        "الريال",
        "الدرهم",
        "الدينار",
    ...
    {
      question:
        "ما هو أصغر محيط في العالم من حيث المساحة؟",
      options: [
        "الهادئ",
        "الأطلسي",
        "المتجمد الشمالي",
    ...
    {
      question:
        "ما هي أول سورة نزلت كاملة في القرآن الكريم؟",
      options: [
        "الفاتحة",
        "العلق",
        "البقرة",
    ...
    {
      question:
        "ما هي أكبر صحراء حارة في العالم؟",
      options: [
        "صحراء الربع الخالي",
        "الصحراء الكبرى",
        "صحراء كلاهاري",
    ...
    {
      question:
        "كم عدد اللاعبين الأساسيين في فريق كرة القدم الواحد؟",
      options: ["9", "10", "11", "12"],
      correct: 3,
    },
  ],
  ...
  3: [
    ...
    {
      question:
        "من هو العالم المسلم الذي يلقب بأبو الجبر؟",
      options: [
        "ابن سينا",
        "الخوارزمي",
        "ابن الهيثم",
    ...
    {
      question:
        "من هو مؤلف كتاب 'ألف ليلة وليلة' الأصلي بلا مؤلف معروف، لكن من جمعها ونشرها في الغرب أول مرة؟",
      options: [
        "أنطوان غالان",
        "ريتشارد بيرتون",
        "إدوارد لين",
    ...
    {
      question:
        "ما هو الغاز الذي يحتاجه الإنسان للتنفس؟",
      options: [
        "ثاني أكسيد الكربون",
        "النيتروجين",
        "الأكسجين",
  ...
  4: [
    {
      question:
        "في أي عام هبط الإنسان على سطح القمر لأول مرة؟",
      options: [
        "1965",
        "1969",
        "1973",
    ...
    {
      question:
        "كم عدد اللغات الرسمية في الأمم المتحدة؟",
      options: ["4", "5", "6", "7"],
      correct: 3,
    },
    {
      question:
        "ما هو أصغر بلد في العالم من حيث المساحة؟",
      options: [
        "موناكو",
        "الفاتيكان",
        "سان مارينو",
    ...
    {
      question:
        "من هو مؤلف الملحمة الشعرية 'الإلياذة'؟",
      options: [
        "سقراط",
        "أفلاطون",
        "هوميروس",
    ...
    {
      question:
        "في أي معركة انتصر المسلمون على الفرس نصراً حاسماً وسقطت بعده دولتهم؟",
      options: [
        "اليرموك",
        "القادسية",
        "بدر",
    ...
    {
      question:
        "من هو أول رئيس لجمهورية مصر العربية بعد إلغاء الملكية؟",
      options: [
        "جمال عبدالناصر",
        "محمد نجيب",
        "أنور السادات",
    ...
    {
      question:
        "ما هي أطول فترة صيام في اليوم بين دول العالم الإسلامي غالباً ما ترتبط بأي فصل؟",
      options: [
        "الشتاء",
        "الصيف",
        "الربيع",
    ...
    {
      question:
        "كم تبلغ سرعة الضوء تقريباً في الفراغ (كم/ثانية)؟",
      options: [
        "150 ألف",
        "300 ألف",
        "500 ألف",
  ...
  5: [
    {
      question:
        "من هو القائد المسلم الذي انتصر في معركة عين جالوت؟",
      options: [
        "صلاح الدين الأيوبي",
        "بيبرس",
        "سيف الدين قطز",
    ...
    {
      question:
        "في أي عام سقطت الأندلس بشكل نهائي بسقوط غرناطة؟",
      options: [
        "1392م",
        "1492م",
        "1592م",
    ...
    {
      question:
        "من هو مؤلف كتاب 'مقدمة ابن خلدون'؟",
      options: [
        "ابن رشد",
        "ابن خلدون",
        "ابن بطوطة",
    ...
    {
      question:
        "ما اسم أول قمر صناعي أُطلق إلى الفضاء؟",
      options: [
        "أبولو 11",
        "سبوتنيك 1",
        "فوستوك 1",
    ...
    {
      question:
        "من هو الخليفة الأموي الذي بنى قبة الصخرة في القدس؟",
      options: [
        "معاوية بن أبي سفيان",
        "عبدالملك بن مروان",
        "الوليد بن عبدالملك",
    ...
    {
      question:
        "ما هو اسم أطول جدار دفاعي في التاريخ يقع في الصين؟",
      options: [
        "سور الصين العظيم",
        "جدار هادريان",
        "خط ماجينو",
    ...
    {
      question:
        "من هو العالم المسلم الذي يعتبر رائد علم البصريات الحديث؟",
      options: [
        "ابن سينا",
        "ابن الهيثم",
        "الخوارزمي",
    ...
    {
      question:
        "في أي عام وقعت غزوة بدر الكبرى؟",
      options: [
        "السنة الأولى للهجرة",
        "السنة الثانية للهجرة",
    ...
    {
      question:
        "ما اسم المعاهدة التي أنهت الحرب العالمية الأولى رسمياً؟",
      options: [
        "معاهدة فرساي",
        "معاهدة يالطا",
        "معاهدة سايكس بيكو",
    ...
    {
      question:
        "ما هي أول جامعة في التاريخ لا تزال قائمة إلى اليوم، وتقع في المغرب؟",
      options: [
        "جامعة الأزهر",
        "جامعة القرويين",
        "جامعة قرطبة",
    ...
    {
      question:
        "من هو القائد الذي فتح بلاد الأندلس؟",
      options: [
        "طارق بن زياد",
        "موسى بن نصير",
        "عقبة بن نافع",
...
async function generateMillionQuestionImage(
  currentQ
) {
...
export function getMillionRecruitmentEmbed(
  gameData
) {
  const playerList =
...
export async function runMillionRound(
  ...
  const embed = new EmbedBuilder()
    .setColor("#1E90FF")
    .setDescription(
      "⏳ **لديك 20 ثانية لاختيار الإجابة بالضغط على الأزرار (1 / 2 / 3 / 4) أدناه!**"
    )
    .setImage("attachment://million.png")
    .setFooter({
      text: `اللاعبون المستمرون الآن: ${gameData.activePlayers.size}`,
    });
